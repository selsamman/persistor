...
module.exports = function (PersistObjectTemplate, baseClassForPersist) {
            ...
            return Promise.resolve()
                .then(function() {
                    ...
                    if (!txn) {
                        ...
                        object.setDirty(txn, false, cascade, logger)
                    }
                }.bind(this));
        };
        ...
        object.delete = function (options) {
            return Promise.resolve()
                .then(function() {
                    ...
                    if (!txn) {
                        return this.persistDelete(null, logger);
                    }
                    else {
                        object.setDelete(txn, false, cascade, logger)
                    }
                }.bind(this));
        };
    ...
    PersistObjectTemplate._injectIntoTemplate = function (template) {
        ...
        template.fetchByQuery = function(query, options) {
            return Promise.resolve()
                .then(function() {
                    Promise.resolve(PersistObjectTemplate._validateParams(options, 'fetchSchema', template));
                    options = options || {};
                    var logger = options.logger || PersistObjectTemplate.logger;
