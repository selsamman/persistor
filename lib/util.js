    ...
    PersistObjectTemplate._validateParams = function validateParams(options, schema, template) {
        ...
        if (!valid) {
            throw new Error('Parameter validation failed, ' +
                (schemaValidator.error.dataPath !== '' ? 'Field: ' + schemaValidator.error.dataPath + ', ' : '') +
        ...
        function validateFetchSpec(template) {
            ...
            function fetchPropChecks(fetch, template, name) {
                Object.keys(fetch).map(function(key) {
                    if (key in template.defineProperties && isObjectTemplateProperty(key, template.props[key])) {
            ...
            function isObjectTemplateProperty(key, template) {
