module.exports = function (PersistObjectTemplate) {
    ...
    PersistObjectTemplate.getFromPersistWithKnexId = function (template, id, cascade, isTransient, idMap, isRefresh, _logger, sessionStore) {
        return this.getFromPersistWithKnexQuery(null, template, {_id: id}, cascade, null, null, isTransient, idMap, null, null, isRefresh, null, sessionStore)
     ...
     * @returns {*}
     */
    PersistObjectTemplate.getFromPersistWithKnexQuery = function (requests, template, queryOrChains, cascade, skip, limit, isTransient, idMap, options, establishedObject, isRefresh, logger, sessionStore)
    {
        ...
        function getTemplatesFromPOJOS(pojos) {
            ...
            pojos.forEach(function (pojo, ix) {
                ...
                promises.push(PersistObjectTemplate.getTemplateFromKnexPOJO(pojo, template, requests, idMap, cascade, isTransient,
                    null, establishedObject, null, this.dealias(template.__table__) + '___', joins, isRefresh, logger, sessionStore)
                    .then(function (obj) {
    ...
    PersistObjectTemplate.getTemplateFromKnexPOJO =
        function (pojo, template, requests, idMap, cascade, isTransient, defineProperty, establishedObj, specificProperties, prefix, joins, isRefresh, logger, sessionStore)
        {
            var self = this;
            prefix = prefix || '';
            ...
            var obj = establishedObj || idMap[pojo[prefix + '_id']] ||
                this._createEmptyObject(persistTemplate || template,
                    this.getObjectId(template, pojo, prefix), defineProperty, isTransient, sessionStore);
