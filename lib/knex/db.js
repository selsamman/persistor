module.exports = function (PersistObjectTemplate) {
     ...
     *
     * @param {supertype} template - objecttemplate
     * @param {Array} joins - array of tables that need to be joined at the current level
     * @param queryOrChains conditions to use, can even pass functions to add extra conditions
     ...
     *
     * @param {supertype} template objecttemplate
     * @param {object} queryOrChains conditions to use, can even pass functions to add extra conditions
     * @param {object} options start, limit, and sort options can be passed..
     * @param {object} map mapper to cache
     * @param {object} logger objecttemplate logger
     * @returns {*}
     ...
     * @param {supertype} template object template
